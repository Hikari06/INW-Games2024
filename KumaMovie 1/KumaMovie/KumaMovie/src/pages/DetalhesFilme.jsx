...
function DetalhesFilme() {
    ...
    return ( 
        <main className="bg-primary-claro text-xl">
            <h1 className="flex justify-center font-bold text-primary-ocre mb-10">{filme.title}</h1>
        <div className="flex justify-center" >
        
        <img className="h-80 w-auto rounded-xl" src={`https://image.tmdb.org/t/p/w1280/${filme.backdrop_path}`}/>
            </div>
            <p class="flex items-center my-10 ml-5 mr-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium similique sequi, illum debitis voluptatibus doloribus ratione molestias voluptate maiores omnis delectus adipisci consequatur itaque exercitationem aliquam tempore in fuga velit.</p>
            <p class="flex items-center my-10 ml-5 mr-5"><div class="flex items-center">
